...
public class Sale implements Serializable {
    ...
    private Integer productId;   // just a plain column, no @ManyToOne
    ...
    public Sale(Integer id, Integer productId, Product product, Integer quantity, LocalDateTime saleDate, BigDecimal salePrice) {
        Id = id;
